...
public class WsContazulCentralizacao {
	...
	public void excluirEstruturaDeCentralizacao(long centralizadora) {
		...
		long[] centralizadas = this.centralizacaoR.findNumeroContazulCentralizadaByNumeroContazulCentralizadora(centralizadora);
	...
	public void descentralizar(long centralizada) {
		...
		Ca02Contazul ca02Contazul = this.contazulR.findByNumeroContazul(centralizacao.getNumeroContazulCentralizadora());
		
		// ATUALIZAR O SALDO DA CENTRALIZADORA
		ca02Contazul.setSaldo(ca02Contazul.getSaldo() - this.getSaldoContazul(centralizacao.getNumeroContazulCentralizada()));
		
		// ATUALIZAR O VALOR IDEAL
		ca02Contazul.setValorIdeal(ca02Contazul.getValorIdeal() - this.getValorIdealContazul(centralizacao.getNumeroContazulCentralizada()));
